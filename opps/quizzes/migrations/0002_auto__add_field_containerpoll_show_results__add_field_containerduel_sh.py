...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContainerPoll.show_results'
        db.add_column(u'quizzes_containerpoll', 'show_results',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ContainerDuel.show_results'
        db.add_column(u'quizzes_containerduel', 'show_results',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
